  ...
  return (
    <main className="ip-page lp-page">
      ...
      <article className="lp-content">
        <p>
          At KZK Services, accessible from{" "}
          <a href="https://kzkservices.com" target="_blank" rel="noopener noreferrer">
            https://kzkservices.com
          </a>
        ...
        <p>
          Like any other website, KZK Services uses &lsquo;cookies&rsquo;.
        ...
        <p>
          KZK Services&apos; Privacy Policy does not apply to other advertisers
        ...
        <p>
          ...
          advertising partners of KZK Services. Third-party ad servers or ad
          ...
          appear on KZK Services, which are sent directly to users&apos;
          ...
          that you see on websites that you visit. Note that KZK Services has
        ...
        <p>
          KZK Services does not knowingly collect any Personal Identifiable
